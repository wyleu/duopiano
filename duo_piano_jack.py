"""
Ruggedising the duo piano with jack
...
class DuoPiano:
    def __init__(self):
        self.client = jack.Client('DUO-Piano')
        self.midiout = self.client.midi_inports.register('duo_in')
        self.midiin = self.client.midi_outports.register('duo_out')
